...
- 개인정보 수집/이용 동의: 앱 사용 전 어떤 정보를 수집하고 어떻게 활용하며 언제 파기하는지에 대한 명확한 동의 절차를 UI/UX 설계에 포함해야 합니다.
- 면책 조항: "본 서비스는 의료적인 진단을 대체할 수 없으며, 참고용으로만 활용해야 합니다.”
- 보안: 사용자 사진 AES-256 암호화 및 24시간 내 삭제
...
![image.png](attachment:5fc79437-dc20-425e-9db8-7d7e1a7a222c:image.png)
...
- **클래스별 특징:**
    - 비교적 데이터가 많은 **농포 (Purulent), Papular(구진)**에서 높은 성능(mAP50 약 0.78 이상) 확보
...
![image.png](attachment:e555b906-8f34-4a75-b9a3-6fd52cd0e47d:image.png)
...
- 문제 해결 능력 : 403 Forbidden, FileNotFoundError 등 개발 중 발생한 **오류를 체계적으로 추적·해결함.**
...
- **팀원 C**
    - **강점**: 대시보드 UX/UI 기획 및 프론트엔드 개발 능력
